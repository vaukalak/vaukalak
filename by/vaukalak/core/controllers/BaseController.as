package by.vaukalak.core.controllers {
	...
	public class BaseController extends CommandDispatcher implements IBaseController{
		...
		public function get baseController():IBaseController { return this; }
		
		public function get dataBase():DataBase { return _dataBase; }
		
		public function get container():DisplayObjectContainer { return _container; }
		
		public function call(commandName:String, responder:Responder, ...args):void {
