...
import by.vaukalak.core.net.loading.multy.strategy.QueueUploadStrategy;
...
public class MultyLoader extends EventDispatcher {
    ...
    private static var _pull:LoadersPull;
    ...
    public function upload(sync:Boolean = true):void {
        ...
        var _uploadStrategy:AbstractUploadStrategy = new QueueUploadStrategy(this);
...
class PullItem {
    ...
    public function get target():LoaderContainer {
        return _target;
    }
